...
-- IMPORTANT: Run this in Supabase SQL Editor - RUN EACH STEP SEPARATELY

-- Check for any triggers on users table
SELECT trigger_name, event_manipulation, event_object_table 
FROM information_schema.triggers 
WHERE event_object_table = 'users' OR event_object_table = 'user_roles';
...
-- Step 5: Insert user with Supabase Auth ID - RUN THIS SEPARATELY AND VERIFY
...
-- Step 6: Verify user was inserted - RUN THIS AFTER STEP 5
SELECT id, full_name, email FROM users WHERE id = '7788b872-8a1b-4dfb-b03f-0311ce0b2082'::uuid;

-- Step 7: Delete existing role mapping - RUN THIS AFTER STEP 6 SHOWS USER EXISTS
DELETE FROM user_roles WHERE user_id = '7788b872-8a1b-4dfb-b03f-0311ce0b2082'::uuid;

-- Step 8: Insert user role mapping - RUN THIS AFTER STEP 7
...
-- Step 9: Re-enable RLS - RUN THIS AFTER STEP 8 SUCCEEDS
ALTER TABLE users ENABLE ROW LEVEL SECURITY;
ALTER TABLE user_roles ENABLE ROW LEVEL SECURITY;

-- Step 10: Verify the complete setup - RUN THIS AT THE END
