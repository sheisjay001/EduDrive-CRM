...
const staffNavigation: NavItem[] = [
  { href: "/dashboard", label: "Dashboard", icon: LayoutDashboard, roles: ["super_admin", "school_admin"] },
  { href: "/admissions-officer/dashboard", label: "Dashboard", icon: LayoutDashboard, roles: ["admissions_officer"] },
  { href: "/bursar/dashboard", label: "Dashboard", icon: LayoutDashboard, roles: ["bursar"] },
  { href: "/teacher/dashboard", label: "Dashboard", icon: LayoutDashboard, roles: ["teacher"] },
  { href: "/helpdesk-officer/dashboard", label: "Dashboard", icon: LayoutDashboard, roles: ["helpdesk_officer"] },
  { href: "/admissions", label: "Admissions", icon: ChartSpline, roles: ["super_admin", "school_admin", "admissions_officer"] },
  { href: "/admissions-officer/leads", label: "Leads", icon: ChartSpline, roles: ["admissions_officer"] },
  { href: "/families", label: "Families", icon: Users, roles: ["super_admin", "school_admin", "admissions_officer"] },
  { href: "/admissions-officer/families", label: "Families", icon: Users, roles: ["admissions_officer"] },
  { href: "/parents", label: "Parents", icon: Sparkles, roles: ["super_admin", "school_admin", "helpdesk_officer"] },
  { href: "/teacher/parents", label: "Parents", icon: Sparkles, roles: ["teacher"] },
  { href: "/students", label: "Students", icon: GraduationCap, roles: ["super_admin", "school_admin", "parent", "student"] },
  { href: "/bursar/students", label: "Students", icon: GraduationCap, roles: ["bursar"] },
  { href: "/teacher/students", label: "Students", icon: GraduationCap, roles: ["teacher"] },
  { href: "/finance", label: "Finance", icon: CreditCard, roles: ["super_admin", "school_admin", "parent"] },
  { href: "/bursar/finance", label: "Finance", icon: CreditCard, roles: ["bursar"] },
  ...
  { href: "/helpdesk-officer/tickets", label: "Tickets", icon: LifeBuoy, roles: ["helpdesk_officer"] },
  ...
  { href: "/bursar/reports", label: "Reports", icon: FileBarChart2, roles: ["bursar"] },
  ...
  { href: "/reminders", label: "Reminders", icon: CalendarCheck, roles: ["super_admin", "school_admin", "student"] },
