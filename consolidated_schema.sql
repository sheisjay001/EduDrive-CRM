-- Consolidated Schema for EduDrive CRM
-- This file combines all *_schema.sql files for easy execution in Supabase SQL Editor
-- Execute this in: Supabase Dashboard → SQL Editor

-- ============================================================================
-- 1. SUPABASE BASE SCHEMA
-- ============================================================================
-- Schools table
...
CREATE INDEX IF NOT EXISTS idx_tickets_school_id ON tickets(school_id);
...
-- ============================================================================
-- NOTE: The remaining 23 schema files contain additional tables and functions.
-- They need to be executed separately or combined here.
-- Due to size limits, please execute the individual *_schema.sql files
-- in the Supabase SQL Editor in the following order:
-- ============================================================================
