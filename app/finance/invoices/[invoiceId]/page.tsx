          ...
          <Card className="space-y-6">
            ...
            <div>
              ...
              <div className="mt-4 space-y-3">
                {data.lineItems.map((item: any) => ( // eslint-disable-line @typescript-eslint/no-explicit-any
          ...
          <Card className="space-y-5">
            ...
            {data.payments.length === 0 ? (
              ...
              <div className="space-y-3">
                {data.payments.map((payment: any) => ( // eslint-disable-line @typescript-eslint/no-explicit-any
